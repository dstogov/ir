...
OBJS_COMMON = $(BUILD_DIR)/ir.o $(BUILD_DIR)/ir_strtab.o $(BUILD_DIR)/ir_cfg.o \
	$(BUILD_DIR)/ir_sccp.o $(BUILD_DIR)/ir_gcm.o $(BUILD_DIR)/ir_ra.o $(BUILD_DIR)/$(EMIT_OBJ) \
...
$(BUILD_DIR)/ir_ra.o: $(SRC_DIR)/ir_$(ARCH_H).h
$(BUILD_DIR)/ir_emit.o: $(SRC_DIR)/ir_$(ARCH_H).h $(BUILD_DIR)/ir_emit_$(DASM_ARCH).h
$(BUILD_DIR)/ir_emit_riscv.o: $(SRC_DIR)/ir_riscv.h
...
$(BUILD_DIR)/gen_ir_fold_hash: $(SRC_DIR)/gen_ir_fold_hash.c $(SRC_DIR)/ir_strtab.c $(SRC_DIR)/ir.h
	$(BUILD_CC) $(BUILD_CFLAGS) $(LDFLAGS) -o $@ $<
...
clean:
	...
	find $(SRC_DIR)/tests -type f -name '*.ir' -not -path '*/riscv/*' -delete
